...
### Title: Create a Rate Limiter
### Aliases: create_rate_limiter
...
base::cat("create_rate_limiter", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("get_steam_app_id")
### * get_steam_app_id

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: get_steam_app_id
### Title: Get Steam App ID from Steam Store Search
### Aliases: get_steam_app_id

### ** Examples

## Not run: 
##D # Find Steam ID for a game
##D bf_id <- get_steam_app_id("Battlefield 2042 Open Beta")
##D print(bf_id)
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("get_steam_app_id", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
##D 
##D # Basic statistics
##D nrow(games_metadata)
##D range(as.Date(games_metadata$releaseDate), na.rm = TRUE)
##D 
##D # Price analysis
##D summary(games_metadata$price)
##D 
##D # Free vs paid games
##D free_games <- sum(games_metadata$price == 0, na.rm = TRUE)
##D free_share <- free_games / nrow(games_metadata)
##D c(free_games = free_games, free_share = free_share)
##D 
##D # Genre analysis
##D all_genres <- unlist(games_metadata$genres)
##D genre_counts <- sort(table(all_genres), decreasing = TRUE)
##D head(genre_counts, 10)
##D 
##D # Tag analysis for trends
##D all_tags <- unlist(games_metadata$tags)
##D tag_counts <- sort(table(all_tags), decreasing = TRUE)
##D head(tag_counts, 20)
##D 
...
cleanEx()
nameEx("vgi_build_cache")
### * vgi_build_cache

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_build_cache
### Title: Build Complete Game Cache
### Aliases: vgi_build_cache

### ** Examples

## Not run: 
##D # Build initial cache
##D vgi_build_cache()
##D 
##D # Force refresh of cache
##D vgi_build_cache(force_refresh = TRUE)
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_build_cache", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
### Title: Get Developer List with Filtering
...
##D valve_devs <- vgi_developer_list(search = "Valve")
##D print(valve_devs)
##D 
##D # Get top developers (limit results)
##D top_devs <- vgi_developer_list(limit = 100)
##D cat("Retrieved", nrow(top_devs), "developers\n")
##D 
##D # Find prolific developers
##D prolific_devs <- vgi_developer_list(min_games = 10, limit = 50)
##D print(prolific_devs)
##D 
##D # Search for studios
##D studios <- vgi_developer_list(search = "Studios", limit = 200)
##D cat("Found", nrow(studios), "studios\n")
##D 
##D # Get developer info for a specific developer
##D dev <- vgi_developer_list(search = "Valve Corporation", limit = 1)
##D if (nrow(dev) > 0) {
##D   valve_info <- vgi_developer_info(dev$id[1])
##D   print(valve_info)
##D }
## End(Not run)
...
cleanEx()
nameEx("vgi_entitlements_by_date")
### * vgi_entitlements_by_date

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_entitlements_by_date
### Title: Get Units Sold Data by Date
### Aliases: vgi_entitlements_by_date
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_entitlements_by_date", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("vgi_fetch_by_ids")
### * vgi_fetch_by_ids

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_fetch_by_ids
### Title: Fetch Games by ID List
### Aliases: vgi_fetch_by_ids

### ** Examples

## Not run: 
##D # Get metadata for specific games
##D games <- vgi_fetch_by_ids(c(730, 578080, 1172470), "metadata")
##D 
##D # Get active players for specific games
##D active <- vgi_fetch_by_ids(c(730, 578080), "active_players", date = "2025-07-26")
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_fetch_by_ids", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("vgi_filter_genre")
### * vgi_filter_genre

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_filter_genre
### Title: Filter Games by Genre
### Aliases: vgi_filter_genre

### ** Examples

## Not run: 
##D # Get all shooters
##D shooters <- vgi_filter_genre("Shooter")
##D 
##D # Get top 10 shooters by revenue rank
##D top_shooters <- shooters %>%
##D   arrange(totalRevenueRank) %>%
##D   head(10)
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_filter_genre", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
## Not run: 
##D # Get all games (WARNING: Large dataset)
##D all_games <- vgi_game_list()
##D cat("Total games in database:", nrow(all_games), "\n")
##D 
##D # Filter locally for shooter games
##D # (Requires fetching metadata for each game to get genre)
##D 
##D # Search for games by name locally
##D cs_games <- all_games[grepl("Counter-Strike", all_games$name, ignore.case = TRUE), ]
##D print(cs_games)
##D 
##D # Cache the complete list for future use
##D cache_file <- file.path(tempdir(), "vgi_all_games_cache.rds")
##D saveRDS(all_games, cache_file)
##D 
##D # Later, load from cache instead of API
##D if (file.exists(cache_file)) {
##D   all_games <- readRDS(cache_file)
##D } else {
##D   all_games <- vgi_game_list()
##D   saveRDS(all_games, cache_file)
##D }
##D 
##D # Get a sample of games
...
## Not run: 
##D # Get default rankings (5 games)
##D rankings <- vgi_game_rankings()
##D 
##D # Get top 100 games
##D rankings <- vgi_game_rankings(limit = 100)
##D 
##D # Get games starting from offset 50
##D rankings <- vgi_game_rankings(offset = 50, limit = 20)
##D 
...
cleanEx()
nameEx("vgi_game_summary")
### * vgi_game_summary

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_game_summary
### Title: Get Comprehensive Game Summary
### Aliases: vgi_game_summary

### ** Examples

## Not run: 
##D # Analyze a single game for one week
##D bf5_summary <- vgi_game_summary(
##D   steam_app_ids = 1238810,  # Battlefield V
##D   start_date = "2024-07-01",
##D   end_date = "2024-07-07"
##D )
##D 
##D # Analyze multiple games
##D battlefield_summary <- vgi_game_summary(
##D   steam_app_ids = c(1517290, 1238810),  # BF2042 and BFV
##D   start_date = "2024-07-01", 
##D   end_date = "2024-07-07",
##D   metrics = c("concurrent", "active", "revenue", "units")
##D )
##D 
##D # View summary table
##D print(battlefield_summary$summary_table)
##D 
##D # Plot time series
##D ggplot(battlefield_summary$time_series$concurrent,
##D        aes(x = date, y = peakConcurrent, color = factor(steamAppId))) +
##D   geom_line() +
##D   labs(title = "Peak CCU Over Time")
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_game_summary", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("vgi_game_summary_yoy")
### * vgi_game_summary_yoy

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_game_summary_yoy
### Title: Get Year-over-Year Game Summary Comparison
### Aliases: vgi_game_summary_yoy

### ** Examples

## Not run: 
##D # Compare Q1 performance across years
##D q1_comparison <- vgi_game_summary_yoy(
##D   steam_app_ids = c(892970, 1145360),
##D   years = c(2023, 2024, 2025),
##D   start_month = "Jan",
##D   end_month = "Mar"
##D )
##D 
##D # Compare specific date ranges
##D holiday_comparison <- vgi_game_summary_yoy(
##D   steam_app_ids = 892970,
##D   years = c(2022, 2023, 2024),
##D   start_date = "11-15",  # Nov 15
##D   end_date = "01-15"     # Jan 15 (crosses year boundary)
##D )
##D 
##D # Compare full years
##D yearly_comparison <- vgi_game_summary_yoy(
##D   steam_app_ids = c(1517290, 1238810),
##D   years = c(2023, 2024),
##D   start_month = "January",
##D   end_month = "December"
##D )
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_game_summary_yoy", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("vgi_get_games_by_id")
### * vgi_get_games_by_id

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_get_games_by_id
### Title: Get Games by Steam App IDs
### Aliases: vgi_get_games_by_id

### ** Examples

## Not run: 
##D # Get specific games
##D games <- vgi_get_games_by_id(c(730, 578080, 1172470))
##D 
##D # Get games with rankings
##D popular_ids <- c(730, 570, 440, 1245620)
##D popular_games <- vgi_get_games_by_id(popular_ids)
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_get_games_by_id", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
##D old_par <- par(no.readonly = TRUE)
##D par(mfrow = c(2, 1))
...
cleanEx()
nameEx("vgi_insights_entitlements")
### * vgi_insights_entitlements

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_insights_entitlements
### Title: Get Entitlements Data for a Game
### Aliases: vgi_insights_entitlements

### ** Examples

## Not run: 
##D # Get entitlements history for a game
##D entitlements_data <- vgi_insights_entitlements(steam_app_id = 730)
##D 
##D # Plot cumulative entitlements over time
##D plot(entitlements_data$date, entitlements_data$entitlementsTotal, 
##D      type = "l", main = "Total Entitlements Over Time",
##D      xlab = "Date", ylab = "Total Entitlements")
##D 
##D # Calculate daily sales for recent period
##D recent_data <- tail(entitlements_data, 30)
##D daily_sales <- mean(recent_data$entitlementsChange, na.rm = TRUE)
##D print(paste("Average daily sales (last 30 days):", round(daily_sales)))
##D 
##D # Find peak sales day
##D peak_day <- entitlements_data[which.max(entitlements_data$entitlementsChange), ]
##D print(paste("Peak entitlements:", peak_day$entitlementsChange, "on", peak_day$date))
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_insights_entitlements", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
##D }
##D 
##D # Plot follower totals and daily changes
##D old_par <- par(no.readonly = TRUE)
##D par(mfrow = c(2, 1))
...
##D         border = NA, xlab = "Observation", ylab = "Daily Change")
##D par(old_par)
## End(Not run)
...
### Title: Get Publisher List with Filtering
...
##D ea_pubs <- vgi_publisher_list(search = "Electronic Arts")
##D print(ea_pubs)
##D 
##D # Get top publishers (limit results)
##D top_pubs <- vgi_publisher_list(limit = 100)
##D cat("Retrieved", nrow(top_pubs), "publishers\n")
##D 
##D # Find major publishers with many games
##D major_pubs <- vgi_publisher_list(min_games = 20, limit = 50)
##D print(major_pubs)
##D 
##D # Search for specific publisher
##D ubi <- vgi_publisher_list(search = "Ubisoft", limit = 1)
##D if (nrow(ubi) > 0) {
##D   # Get more info about this publisher
##D   ubi_info <- vgi_publisher_info(ubi$id[1])
##D   print(ubi_info)
##D }
##D 
##D # Find publishers with "Games" in name
##D games_pubs <- vgi_publisher_list(search = "Games", limit = 200)
##D cat("Publishers with 'Games' in name:", nrow(games_pubs), "\n")
##D 
##D # Export for analysis
##D top_100 <- vgi_publisher_list(limit = 100)
##D output_file <- file.path(tempdir(), "vgi_top_publishers.csv")
##D write.csv(top_100, output_file, row.names = FALSE)
## End(Not run)
...
cleanEx()
nameEx("vgi_smart_game_search")
### * vgi_smart_game_search

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_smart_game_search
### Title: Smart Game Search using Publisher/Developer Relationships
### Aliases: vgi_smart_game_search

### ** Examples

## Not run: 
##D # Find all games from Battlefield's publisher (EA)
##D ea_games <- vgi_smart_game_search("battlefield", search_type = "publisher")
##D print(ea_games)
##D 
##D # Find all games from the developer of Gothic
##D gothic_dev_games <- vgi_smart_game_search("gothic", search_type = "developer")
##D print(gothic_dev_games)
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_smart_game_search", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("vgi_smart_search")
### * vgi_smart_search

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: vgi_smart_search
### Title: Smart Game Search with Filtering
### Aliases: vgi_smart_search

### ** Examples

## Not run: 
##D # Get top 20 shooters by revenue
##D shooters <- vgi_smart_search(genre = "Shooter", metric = "revenue", limit = 20)
##D 
##D # Get all games by a specific developer
##D valve_games <- vgi_smart_search(developer = "Valve")
## End(Not run)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vgi_smart_search", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
